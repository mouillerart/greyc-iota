...
public class FilterRecordTimeInterface extends javax.swing.JDialog {

    private static final Log log = LogFactory.getLog(FilterRecordTimeInterface.class);

    /**
     * Creates new form FilterUser
     */
    public FilterRecordTimeInterface(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButtonOKActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            dates.add(lowDate);
            dates.add(highDate);
            vue.handleRecordTimeAdding(dates);
            this.setVisible(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                FilterRecordTimeInterface dialog = new FilterRecordTimeInterface(new javax.swing.JFrame(), true);
