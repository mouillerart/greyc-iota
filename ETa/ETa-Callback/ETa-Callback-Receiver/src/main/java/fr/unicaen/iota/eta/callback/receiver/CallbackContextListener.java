...
/**
 * This
 * <code>CallbackContextListener</code> performs the initialization and
 * termination (shut-down) work required by the Callback application, such as
 ...
 */
public class CallbackContextListener implements ServletContextListener {

    private static final Log LOG = LogFactory.getLog(CallbackContextListener.class);
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        LOG.info("Starting Callback application");
    ...
    public void contextDestroyed(ServletContextEvent event) {
        LOG.info("Callback application shut down\n######################################");
