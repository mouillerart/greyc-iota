...
class ETaCallbackFilterInstaller(installer.WebAppInstaller):

    def __init__(self):
        installer.WebAppInstaller.__init__(self, "ETa Callback Filter web application", "eta_callback_filter", [
                ("Enter the ETa Callback Filter web application name", "eta_callback_filter", "name", {}),
                ("Enter the archive file pathname", "eta_callback_filter", "repo_war", {"type": "file"}),
    ...
    def postConfigure(self):
        self.cset("repo", self.cget("repo_war"))
