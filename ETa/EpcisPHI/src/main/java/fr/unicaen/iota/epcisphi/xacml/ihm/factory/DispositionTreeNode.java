...
public class DispositionTreeNode implements TreeNode {
    ...
    public DispositionTreeNode(String v, String id, String gID, Module module) {
        this.value = v;
        this.id = id;
        this.groupID = gID;
        this.module = module;
    ...
    public NodeType getNodeType() {
        return NodeType.dispositionFilterNode;
    }
