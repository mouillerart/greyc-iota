...
/*
   ...
   $Log: NewArcAction.java,v $
   Revision 1.13  2001/10/11 16:58:17  oschmann
   Neue Release

   Revision 1.11  2001/06/12 09:30:42  gruenewa
 *** empty log message ***
 ...
 */
public class NewArcAction extends ActionObject {
    /**
     ...
     */
    public NewArcAction(Object initiator, Node source, Node target, Hashtable extIdToValue) {
        super(initiator);
    ...
    public void performAction(Observer observer, Object observedObject) {
        if (observer instanceof NetObserver) {
            ((NetObserver)observer).newArc((Arc)observedObject);
        }
    }     // performAction
} // NewArcAction