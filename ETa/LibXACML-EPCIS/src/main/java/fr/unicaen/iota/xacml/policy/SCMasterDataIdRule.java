...
public class SCMasterDataIdRule extends SCRule {

    private static final Log log = LogFactory.getLog(SCMasterDataIdRule.class);
    public static final String RULEFILTER = "MasterDataId";

    @Override
    protected String getId() {
        return "urn:oasis:names:tc:xacml:1.0:resource:masterdata-id";
    }

    public SCMasterDataIdRule(String name, List masterDataIds, OneOrGlobalFunction masterDataIdsFilterFunction) {
        super(name, masterDataIds, masterDataIdsFilterFunction);
        description = "Master Data Id filter for SC: " + this.name;
    }

    public SCMasterDataIdRule(String ruleId, List values) {
        super(ruleId, values);
        description = "Master Data Id filter for SC: " + this.name;
    }

    public SCMasterDataIdRule(String ruleId, List values, String actions) {
