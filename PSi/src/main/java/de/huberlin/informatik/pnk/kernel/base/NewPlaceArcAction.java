...
/*
   ...
   $Log: NewPlaceArcAction.java,v $
   Revision 1.3  2001/10/11 16:58:22  oschmann
   Neue Release

   Revision 1.1  2001/06/12 09:30:45  gruenewa
 *** empty log message ***
 ...
 */
public class NewPlaceArcAction extends ActionObject {
    /**
     ...
     */
    public NewPlaceArcAction(Object initiator, Node source, Node target, Hashtable extIdToValue) {
        super(initiator);
    ...
    public void performAction(Observer observer, Object observedObject) {
        if (observer instanceof NetObserver) {
            ((NetObserver)observer).newPlaceArc((PlaceArc)observedObject);
        }
    }     // performAction
} // NewPlaceArcAction