...
public class SCReadPointRule extends SCRule {

    private static final Log log = LogFactory.getLog(SCReadPointRule.class);
    public static final String RULEFILTER = "ReadPoint";

    @Override
    protected String getId() {
        return "urn:oasis:names:tc:xacml:1.0:resource:readPoint-id";
    }

    SCReadPointRule(String name, List readPoints, OneOrGlobalFunction readPointsFilterFunction) {
        super(name, readPoints, readPointsFilterFunction);
        description = "ReadPoint filter for SC: " + this.name;
    }
    ...
    public SCReadPointRule(String ruleId, List values) {
        super(ruleId, values);
    }

    public SCReadPointRule(String ruleId, List values, String actions) {
