 ...
 *
 */
public class SCEPCClassRule extends SCRule {

    private static final Log log = LogFactory.getLog(SCEPCClassRule.class);
    public static String RULEFILTER = "EpcClass";

    @Override
    protected String getId() {
        return "urn:oasis:names:tc:xacml:1.0:resource:epcClass-id";
    }

    public SCEPCClassRule(String ruleId, List values) {
        super(ruleId, values);
    }

    public SCEPCClassRule(String ruleId, List values, String actions) {
        super(ruleId, values, actions);
    }

    SCEPCClassRule(String name, List epcClasses, OneOrGlobalFunction epcClassesFilterFunction) {
        super(name, epcClasses, epcClassesFilterFunction);
    }
