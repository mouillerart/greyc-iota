...
public class SCDateBivaluesExtensionRule extends SCExtensionBivaluesRule {

    private static final Log log = LogFactory.getLog(SCDateBivaluesExtensionRule.class);

    public SCDateBivaluesExtensionRule(String ruleId, String extensionName, List values) throws Exception {
        super(ruleId, extensionName, values);
    }

    public SCDateBivaluesExtensionRule(String ruleId, String extensionName, List values, String actions) throws Exception {
        super(ruleId, extensionName, values, actions);
    }

    public SCDateBivaluesExtensionRule(String ruleId, String extensionName, List values, OneOrGlobalFunction extensionsFilterFunction) {
