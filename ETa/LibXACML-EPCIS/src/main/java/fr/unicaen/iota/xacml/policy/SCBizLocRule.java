...
public class SCBizLocRule extends SCRule {

    private static final Log log = LogFactory.getLog(SCBizLocRule.class);
    public static final String RULEFILTER = "BizLoc";

    @Override
    protected String getId() {
        return "urn:oasis:names:tc:xacml:1.0:resource:bizLoc-id";
    }
    
    SCBizLocRule(String name, List bizLocs, OneOrGlobalFunction bizLocsFilterFunction) {
        super(name, bizLocs, bizLocsFilterFunction);
        description = "BizLoc filter for SC: " + this.name;
    }
    ...
    public SCBizLocRule(String ruleId, List values) {
        super(ruleId, values);
    }

    public SCBizLocRule(String ruleId, List values, String actions) {
