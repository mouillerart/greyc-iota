...
public class MasterDataIdTreeNode implements TreeNode {
    ...
    public MasterDataIdTreeNode(String v, String id, String gID, Module module) {
        this.value = v;
        this.id = id;
        this.groupID = gID;
        this.module = module;
    ...
    public NodeType getNodeType() {
        return NodeType.masterDataIdFilterNode;
    }
